...
class JSON::LD::Context
  add_preloaded("http://prefix.cc/context") do
    new(processingMode: "json-ld-1.1", term_definitions: {
      ...
      "mesh" => TermDefinition.new("mesh", id: "http://purl.bioontology.org/ontology/MESH/", simple: true, prefix: true),
      ...
      "test" => TermDefinition.new("test", id: "http://test.example.com/", simple: true, prefix: true),
