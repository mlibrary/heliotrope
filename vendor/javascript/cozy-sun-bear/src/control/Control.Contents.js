  ...
  _bindEvents() {
    ...
    this._reader.on('updateContents', function(data) {
      ...
      this._modal = this._reader.modal({
        template: `
${this.options.showPageList === false ? '' : `<div class="cozy-contents-toolbar button-group" aria-hidden="true">
...
<div class="cozy-contents-main">
  ...
  ${this.options.showPageList === false ? '' : `<div class="cozy-contents-pagelist" style="display: none">
    ${this.options.showPageListForm === false ? '' : `<form>
    ...
    this._reader.on('updateLocations', (data) => {
      ...
      if ( this._reader.pageList && this._toolbar ) {
        // this._toolbar.style.display = 'flex';
        this._toolbar.setAttribute('aria-hidden', 'false');
      }

      if ( self._reader.pageList && self._display.pagelist ) {
