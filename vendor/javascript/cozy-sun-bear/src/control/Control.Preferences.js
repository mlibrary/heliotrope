...
export var Preferences = Control.extend({
  ...
  defaultTemplate: `<button class="button--sm cozy-preferences" data-toggle="open" aria-label="Aa Text display preferences and settings" title="Text display preferences and settings">Aa</button>`,
