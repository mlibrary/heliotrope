export class InputTracker {
  ...
  constructor(element, notifier) {
    ...
    /*
    This is an override of app/assets/javascripts/hyrax/file_manager/member.es6 in Hyrax 4
    HELIOTROPE OVERRIDE SEE HELIO-4598, https://github.com/samvera/hyrax/issues/6361
    With Hyrax 5 we can get remove this entire file
    */
