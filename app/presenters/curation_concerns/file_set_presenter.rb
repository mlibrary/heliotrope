module CurationConcerns
  class FileSetPresenter
    ...
    # Metadata Methods
    delegate :title, :resource_type, :caption, :alt_text, :description, :copyright_holder, :content_type, :creator, :contributor, :date_created, :keywords, :relation, :publisher, :identifier, :language, :date_uploaded, :rights, :embargo_release_date, :lease_expiration_date, :depositor, :tags, :title_or_label, :external_resource, :persistent_id, to: :solr_document
