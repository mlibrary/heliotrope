...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.default_solr_params = {
      qf: 'title_tesim creator_tesim creator_full_name_tesim creator_display_tesim subject_tesim description_tesim keywords_tesim contributor_tesim caption_tesim transcript_tesim translation_tesim alt_text_tesim identifier_tesim isbn_tesim isbn_ssim',
      qt: 'search',
      rows: 10
    }
