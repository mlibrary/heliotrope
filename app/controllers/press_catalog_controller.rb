  ...
  private
    ...
    def conditional_blacklight_configuration # rubocop:disable Metrics/PerceivedComplexity, Metrics/CyclomaticComplexity
      ...
      if Incognito.developer?(current_actor)
        ...
        blacklight_config.add_facet_field 'author_place_of_origin_sim', label: "Author Place of Origin", limit: false, url_method: :facet_url_helper, sort: sort
        ...
        blacklight_config.add_facet_field 'author_place_of_origin_sim', label: "Author Place of Origin", limit: 5, url_method: :facet_url_helper, sort: sort
        if ['heb', 'bigten', 'boydellandbrewer'].include? @press.subdomain
