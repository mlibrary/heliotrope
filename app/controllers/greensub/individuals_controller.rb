  ...
  class IndividualsController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @individual.save
          format.html { redirect_to greensub_individual_path(@individual), notice: 'Individual was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @individual.update(individual_params)
          format.html { redirect_to greensub_individual_path(@individual), notice: 'Individual was successfully updated.' }
    ...
    def destroy
      @individual.destroy
      respond_to do |format|
        format.html { redirect_to greensub_individuals_path, notice: 'Individual was successfully destroyed.' }
