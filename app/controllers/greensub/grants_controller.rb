  ...
  class GrantsController < ApplicationController
    ...
    def create # rubocop:disable Metrics/CyclomaticComplexity, Metrics/PerceivedComplexity
      ...
      respond_to do |format|
        if success
          format.html { redirect_to greensub_grants_path, notice: 'Grant was successfully created.' }
    ...
    def destroy
      ...
      @grant.delete
      respond_to do |format|
        format.html { redirect_to greensub_grants_path, notice: 'Grant was successfully destroyed.' }
