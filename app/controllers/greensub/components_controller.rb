  ...
  class ComponentsController < ApplicationController
    ...
    def create # rubocop:disable  Metrics/PerceivedComplexity
      if params[:product_id].present?
        ...
        respond_to do |format|
          if @component.save
            format.html { redirect_to greensub_component_path(@component), notice: 'Component was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @component.update(component_params)
          format.html { redirect_to greensub_component_path(@component), notice: 'Component was successfully updated.' }
    ...
    def destroy
      if params[:product_id].present?
        ...
        @component.destroy
        respond_to do |format|
          format.html { redirect_to greensub_products_path, notice: 'Component was successfully destroyed.' }
