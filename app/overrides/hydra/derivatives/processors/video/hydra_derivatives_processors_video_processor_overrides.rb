    ...
    protected
      ...
      def options_for(format)
        ...
        if format == "jpg"
          ...
          # no `-b:v`, let FFmpeg decide as the `filter_complex` scaling means a variety of resolutions are covered
          # set pretty good audio quality across-the-board too
          output_options += "-g 30 -ac 2 -ab 192k -ar 44100"
        end
