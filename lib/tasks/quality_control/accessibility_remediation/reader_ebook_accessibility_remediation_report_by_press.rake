...
namespace :heliotrope do
  task :reader_ebook_accessibility_remediation_report_by_press, [:directory, :subdomain] => :environment do |_t, args|
    ...
    # in the case of a monograph with a EPUB ebook for the reader and a PDF ebook for download, the hits here will combine both
    # this is good enough for our purposes, which is to highlight the most-used
