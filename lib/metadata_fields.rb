...
METADATA_FIELDS ||=
  [
    ...
    { object: :file_set, field_name: 'Resource Type', metadata_name: 'resource_type', required: true, multivalued: :yes, acceptable_values: ['audio', 'image', 'dataset', 'table', '3D model', 'text', 'video'], description: I18n.t('csv.descriptions.resource_type') },
    ...
    { object: :universal, field_name: 'CC License', metadata_name: 'license', required: false, multivalued: :yes, acceptable_values: Hyrax::LicenseService.new.select_active_options.map { |a| a[1] }, description: I18n.t('csv.descriptions.license') },
