...
METADATA_FIELDS =
  [
    ...
    { object: :file_set, field_name: 'Book and Platform (BP) or Platform-only (P)', metadata_name: 'exclusive_to_platform', required: true, multivalued: :no, acceptable_values: ['yes', 'no'] },
