...
RSpec.describe Hyrax::MonographPresenter do
  ...
  describe '#previous_edition_presenter' do
    ...
    context 'next edition link points to another Monograph with necessary fields set' do
      ...
      before do
        allow(mono_doc).to receive(:previous_edition).and_return('https://test.host/concern/monographs/000000000')
        # SolrService.add takes hashes not docs!
      ...
      context 'user can read the linked previous_edition Monograph' do
        ...
        it 'instantiates a MonographPresenter' do
          ...
          expect(subject.edition_name).to eq 'Second Edition'
  ...
  describe '#previous_edition_url' do
    ...
    context 'a Fulcrum Monograph link' do
      before do
