...
RSpec.describe Royalty::CalculationReport do
  ...
  describe "different case rightsholders" do
    ...
    it "have seperate reports" do
      ...
      # Update: we don't use Box and more, UMich doesn't use Box anymore. But I'll leave this spec (without the Box stuff)
      # since it demonstrates a kind of weird edge case involving case.
    end
  end
