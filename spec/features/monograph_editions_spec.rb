...
describe 'Press Catalog' do
  before do
    ...
    create(:public_monograph,
           ...
           next_edition: Rails.application.routes.url_helpers.hyrax_monograph_url('222222222'),
    ...
    create(:public_monograph,
           ...
           previous_edition: Rails.application.routes.url_helpers.hyrax_monograph_url('111111111'),
           next_edition: Rails.application.routes.url_helpers.hyrax_monograph_url('333333333'),
    ...
    create(:public_monograph,
           ...
           previous_edition: Rails.application.routes.url_helpers.hyrax_monograph_url('222222222'),
  ...
  it 'shows expected edition info on each monograph page' do
    ...
    expect(page).to have_link('Read a newer version of The First Edition Title',
                              href: Rails.application.routes.url_helpers.hyrax_monograph_url('222222222'))
    ...
    expect(page).to have_link('Looking for an older version of The Second Edition Title?',
                              href: Rails.application.routes.url_helpers.hyrax_monograph_url('111111111'))
    expect(page).to have_link('Read a newer version of The Second Edition Title',
                              href: Rails.application.routes.url_helpers.hyrax_monograph_url('333333333'))
    # monograph's own Altmetric data
