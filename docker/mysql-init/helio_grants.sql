...
GRANT CREATE, ALTER, INDEX, DROP, INSERT, UPDATE, DELETE, SELECT, REFERENCES ON `heliotrope_development`.* TO 'helio'@'%';
GRANT CREATE, ALTER, INDEX, DROP, INSERT, UPDATE, DELETE, SELECT, REFERENCES ON `heliotrope_test`.* TO 'helio'@'%';
FLUSH PRIVILEGES;