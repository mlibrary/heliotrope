    ...
    */
    $.fn.ihavecookies = function(options, event) {
        ...
        if (!myCookie || !myCookiePrefs || event == 'reinit') {
            ...
            var cookieTypes = '<li><input id="gdpr-cookietype-necessary" type="checkbox" name="gdpr[]" value="necessary" checked="checked" disabled="disabled"> <label for="gdpr-cookietype-necessary" title="' + settings.fixedCookieTypeDesc + '">' + settings.fixedCookieTypeLabel + '</label></li>';
            ...
            var cookieMessage = '<div id="gdpr-cookie-message"><h4 class="gamma">' + settings.title + '</h4><p>' + settings.message + ' <a href="' + settings.link + '">' + settings.moreInfoLabel + '</a><div id="gdpr-cookie-types" style="display:none;"><h5>' + settings.cookieTypesTitle + '</h5><ul>' + cookieTypes + '</ul></div><p><button id="gdpr-cookie-accept" type="button">' + settings.acceptBtnLabel + '</button><button id="gdpr-cookie-advanced" type="button">' + settings.advancedBtnLabel + '</button></p></div>';
            setTimeout(function(){
