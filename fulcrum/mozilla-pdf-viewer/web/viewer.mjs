...
{
  // heliotrope modification: suppress the fallback demo PDF so the viewer waits
  // for PDFViewerApplication.open() called from show_pdf.html.erb. Without this
  // the viewer tries to load "compressed.tracemonkey-pldi-09.pdf" on startup.
  // Re-apply this block whenever re-vendoring pdf.js (check line number after upgrade).
